...
tfidf_df.index = lemmatized_df['document_id']

# TF-IDF DataFrame'ini kaydetme
tfidf_df.to_csv(os.path.join(processed_data_dir, "tfidf_lemmatized.csv"))

print(f"Lemmatization sonrası TF-IDF matris boyutu: {tfidf_df.shape}")
print(f"TF-IDF matrisi '{processed_data_dir}tfidf_lemmatized.csv' dosyasına kaydedildi.")
